...
starterPrompt:
  ...
  body: >-
    ...
    Return the final Markdown report and inline code comments for findings that
...
suspicion that still needs confirmation and can include inline code comments
for affected lines. For an actionable result, open a new bounded
