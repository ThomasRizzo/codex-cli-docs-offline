...
To learn more about how to install and use plugins and skills, see the [plugins documentation](https://developers.openai.com/codex/plugins) and [skills documentation](https://developers.openai.com/codex/build-skills).
...
- Create or update `script/build_and_run.sh` so the build/run loop stays shell-first.
