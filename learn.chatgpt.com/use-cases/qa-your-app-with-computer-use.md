...
If you already maintain a test-plan file in the repo, attach it to the chat or point Codex at it so the QA pass follows your existing flows.
...
After the QA pass, keep the same chat open and ask Codex to fix one of the bugs it found, turn the findings into Linear or GitHub-ready drafts, or narrow the next pass to one specific failing flow.
