...
[Learn about plugins
    ...
    Find, install, and use plugins in ChatGPT and Codex.](plugins.html)
...
[Review personalization settings
    ...
    Set a default personality, custom instructions, and other app preferences.](reference/settings.html#personalization)
