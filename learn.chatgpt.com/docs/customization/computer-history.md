...
Computer History is **off by default** for ChatGPT Pro, Business, and
  ...
  History also requires [Memories](memories.html) and is not
...
- **Memories:** Computer History also requires [Memories](memories.html).
...
[chat-level controls as other Codex memories](memories.html#control-memories-per-chat).
