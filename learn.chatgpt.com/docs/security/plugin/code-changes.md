...
finding](fix-findings.html) or [export and track
...
CI](../cli/ci.html) for structured JSON, a severity policy, and SARIF
...
[plugin changelog](changelog.html) before you depend on a
