...
The Codex Security SDK is [publicly available on
  ...
  Security CLI quickstart](cli.html).
...
Bedrock](cli/reference.html#use-amazon-bedrock), set
...
Continue with the [CLI quickstart](cli.html), [CI
guide](cli/ci.html), or [CLI
reference](cli/reference.html).