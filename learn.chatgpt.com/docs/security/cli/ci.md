...
reference](reference.html). For an interactive plugin-based CI
review, see [Review code changes for security](../plugin/code-changes.html#automate-reviews-in-cicd).