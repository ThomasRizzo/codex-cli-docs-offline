...
[ChatGPT Work Overview](chatgpt-work-overview.html).
...
- **Plugins and apps:** Plugin policy governs plugin availability and
  ...
  available. See [Plugin controls](apps-and-connectors.html),
...
- **Credits:** ChatGPT Work and Codex share pricing, credits, and usage limits.
  ...
  [ChatGPT usage limits and spend controls](usage-limits.html).
...
[Admin rollout guide](admin-setup.html) and
[Governance](governance.html) alongside the workspace controls.
...
[Compliance API](compliance-api.html) documentation for exact data
...
[Workspace analytics](workspace-analytics.html) and the
...
[managed configuration](managed-configuration.html) and
...
see [ChatGPT Work: usage and cost](chatgpt-work-usage-and-cost.html).
...
| ------------------------ | ----------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| Work overview            | How cloud execution, browser access, network policy, and data boundaries work | [ChatGPT Work Overview](chatgpt-work-overview.html) |
| Workspace setup and RBAC | Who can use and administer Codex                                              | [Admin rollout guide](admin-setup.html)             |
...
| Managed policy           | How admins enforce Codex settings users can't override                        | [Managed configuration](managed-configuration.html) |
...
| Observability            | How analytics, reporting, and compliance exports work                         | [Governance](governance.html)                       |
| Automation credentials   | How access tokens are created, limited, revoked, and audited                  | [Access tokens](access-tokens.html)                 |
